...
export interface OnCyberCommunityFactoryFacetInterface extends utils.Interface {
  functions: {
...
export interface OnCyberCommunityFactoryFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OnCyberCommunityFactoryFacetInterface;
