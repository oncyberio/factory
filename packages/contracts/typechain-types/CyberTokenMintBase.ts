...
export interface CyberTokenMintBaseInterface extends ethers.utils.Interface {
  functions: {
...
export interface CyberTokenMintBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CyberTokenMintBaseInterface;
