...
interface CyberSceneFactoryFacetInterface extends ethers.utils.Interface {
  functions: {
...
export class CyberSceneFactoryFacet extends BaseContract {
  ...
  interface: CyberSceneFactoryFacetInterface;
