const config = {
  ...
  supportedContracts: process.env.SUPPORTED_CONTRACTS
    ? process.env.SUPPORTED_CONTRACTS.split(',')
    : ['destination', 'destinationUtility'],
  destination: {
    allowedMinter: process.env.DESTINATION_ALLOWED_MINTER_ADDRESS
      ? process.env.DESTINATION_ALLOWED_MINTER_ADDRESS.split(',')
      : [
          '0xBeb171bA24e66014F356Bca0DB05329EFea14964',
          '0x9e82ba3123107087aEeEfc46f6e47810f29537dF',
        ],
    minterNonceMax: parseInt(process.env.DESTINATION_MINTER_MAX_NONCE || '99'),
    minOncyberShares: parseFloat(
      process.env.NEXT_PUBLIC_MIN_ONCYBER_SHARES || '0.3'
    ), // 30%
    rpc:
  ...
  destinationUtility: {
    allowedMinter: process.env.DESTINATION_UTILITY_ALLOWED_MINTER_ADDRESS
      ? process.env.DESTINATION_UTILITY_ALLOWED_MINTER_ADDRESS.split(',')
      : [
          '0xBeb171bA24e66014F356Bca0DB05329EFea14964',
          '0x76DB02500F7631d57BC2DcDCa9d4cf782b99E119',
        ],
    minterNonceMax: parseInt(
      process.env.DESTINATION_UTILITY_MINTER_MAX_NONCE || '99'
    ),
    minOncyberShares: parseFloat(
      process.env.NEXT_PUBLIC_MIN_ONCYBER_SHARES || '0.3'
    ), // 30%
  ...
  pinata: {
    ...
    externalUrlBase:
      ...
      'https://oncyber.io/destinations/',
  },
  biconomyApiKey:
    process.env.NEXT_PUBLIC_BICONOMY_API_KEY ||
    'iK6oLx9Lw.c19fe6a5-924e-49dc-8a28-e54466b7ccd8',
